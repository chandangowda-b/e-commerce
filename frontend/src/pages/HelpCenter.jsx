...
const FAQItem = ({ item, isOpen, onToggle }) => (
  <div className="border border-white/10 rounded-lg mb-4">
    ...
    >
      ...
      <FaChevronDown
        className={`text-blue-500 transition ${isOpen ? "rotate-180" : ""}`}
      />
    </button>
    {isOpen && (
    ...
    <div className="bg-black text-white min-h-screen pt-20 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          {/* Phone */}
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center hover:border-blue-500 transition">
            ...
            <p className="text-blue-400 font-semibold">1-800-CARCARE</p>
        ...
        {/* Support Hours */}
        <div className="bg-gradient-to-r from-blue-600/20 to-blue-700/20 border border-blue-500/30 rounded-xl p-8">
          <h2 className="text-2xl font-bold mb-6">Our Support Hours</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-blue-400 mb-3">Phone & Email</h3>
            ...
            <div>
              <h3 className="font-semibold text-blue-400 mb-3">Live Chat</h3>
              <ul className="space-y-2 text-gray-300">
