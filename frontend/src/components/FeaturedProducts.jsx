...
import steeringWheel from "../assets/products/steering_wheel.png";
import ledlight from "../assets/products/ledlight.jpg";

const fallbackProducts = [
  { id: 101, images: [steeringWheel], title: "Premium Alloy Wheel", price: 199, brand: "Generic", rating: 4.5 },
  { id: 102, images: [steeringWheel], title: "Sport Seat Cover", price: 149, brand: "Generic", rating: 4.2 },
  { id: 103, images: [ledlight], title: "LED Headlight", price: 249, brand: "Generic", rating: 4.6 },
  { id: 104, images: [steeringWheel], title: "Long-Life Battery", price: 179, brand: "Generic", rating: 4.3 },
  { id: 105, images: [steeringWheel], title: "Ceramic Brake Pads", price: 129, brand: "ProStop", rating: 4.4 },
  { id: 106, images: [steeringWheel], title: "Performance Suspension Kit", price: 549, brand: "RideTech", rating: 4.7 },
  { id: 107, images: [steeringWheel], title: "High-Flow Air Filter", price: 59, brand: "AirFlowX", rating: 4.1 },
  { id: 108, images: [steeringWheel], title: "Ignition Coil Pack", price: 89, brand: "SparkPro", rating: 4.2 },
];
...
export default function FeaturedProducts() {
  ...
  const items = allProducts && allProducts.length ? allProducts : fallbackProducts;
        ...
        {items.map((item, index) => (
          <motion.div
            ...
            className="min-w-60 bg-white/10 backdrop-blur-lg border 
              ...
              hover:shadow-[0_0_25px_#0000ffbb] hover:border-blue-600 
              transition select-none snap-start"
          >
            <img
              src={(item.images && item.images[0]) || item.img || steeringWheel}
              alt={item.title}
              className="w-full h-36 object-contain drop-shadow-xl"
            />
            ...
            <div className="mt-4 flex gap-3">
              <button
                ...
                className="flex-1 py-2 bg-blue-500 hover:bg-blue-600 rounded-lg text-sm font-semibold transition"
              >
                Add to Cart
              </button>
              ...
              <button
                ...
                className="flex-1 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-sm font-semibold transition"
              >
                View
              </button>
            </div>
