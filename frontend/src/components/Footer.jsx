      ...
      <div className="relative mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 backdrop-blur-xl bg-white/5 rounded-2xl p-10 border border-white/10">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white tracking-widest">
            CAR<span className="text-blue-500">CARE</span>
          </h2>
          ...
          <div className="mt-5 flex gap-4">
            <a className="hover:text-blue-500 transition" href="#">Facebook</a>
            <a className="hover:text-blue-500 transition" href="#">Instagram</a>
            <a className="hover:text-blue-500 transition" href="#">YouTube</a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li className="hover:text-blue-400 cursor-pointer transition">Interior Accessories</li>
            <li className="hover:text-blue-400 cursor-pointer transition">Exterior Accessories</li>
            <li className="hover:text-blue-400 cursor-pointer transition">Car Electronics</li>
            <li className="hover:text-blue-400 cursor-pointer transition">Performance Parts</li>
            <li className="hover:text-blue-400 cursor-pointer transition">Car Lighting</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li className="hover:text-blue-400 cursor-pointer transition">Warranty Policies</li>
            <li className="hover:text-blue-400 cursor-pointer transition">Shipping & Returns</li>
            <li className="hover:text-blue-400 cursor-pointer transition">Order Tracking</li>
        ...
        <div>
          ...
          <div className="flex bg-white/10 rounded-lg overflow-hidden backdrop-blur-md border border-white/10">
            ...
            />
            <button className="bg-blue-600 px-5 text-white font-semibold hover:bg-blue-700 transition">
              Join
            </button>
          </div>
        </div>
